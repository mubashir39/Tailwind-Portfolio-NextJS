      ...
      <div className="container mx-auto px-10">
        ...
        <div className="relative flex items-center">
          ...
          >
            ...
            <SkillCard icon={<FaGitAlt />} title="Web Designing" description="" />
...
const SkillCard: React.FC<SkillCardProps> = ({ icon, title, description }) => (
  <div className="min-w-[50px] bg-red-800 text-white p-6 rounded-lg shadow-lg flex flex-col items-center hover:scale-100 transition-transform duration-400 md:animate-fadeIn md:hover:animate-bounceHover">
